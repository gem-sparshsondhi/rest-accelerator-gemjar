...
public class UtilityFunctions {
    ...
    public static List<Request> reqSpecList = new ArrayList<>();
    ...
    public static void setBaseURI(String URI) {
        reqSpecList.get(activeIndex).setBaseUrl(URI);
    }
    ...
    public static void setBasePath(String path) {
        reqSpecList.get(activeIndex).setParameter(path);
    }

    /**
     * Sets a Header to the latest RequestSpecification<p>
     * Warning: If this function is called again it will overwrite the previously set value
     *
     * @param headerName
     * @param headerValue
     */
    public static void addHeader(String headerName, String headerValue) {
        reqSpecList.get(activeIndex).setHeaders("{"+headerName+":"+headerValue+"}");
    }
    ...
    public static void addHeaders(HashMap<String, String> headers) {
        reqSpecList.get(activeIndex).setHeaders(headers);
    }
    ...
    public static void addQueryParam(String paramName, String paramValue) {
        reqSpecList.get(activeIndex).setParameter(paramName, paramValue);
    }
    ...
    public static void addQueryParams(HashMap<String, String> params) {
        reqSpecList.get(activeIndex).setParameter(params);
    }
    ...
    public static void setContentType(String contentType) {
        reqSpecList.get(activeIndex).setContentType(contentType);
    }
...
//        reqSpecList.get(activeIndex).urlEncodingEnabled(encodingStatus);
    ...
    public static void userSetsRequestBodyFromFile(String fileName) {
        ...
        reqSpecList.get(activeIndex).setRequestPayload(content);
    }
    ...
    public static void addMultipartFileToRequest(String controlName, String filename) {
        ...
        reqSpecList.get(activeIndex).setFilePath("src/test/resources/multipartfiles/" + filename);
    }
    ...
    public static void makeRequest(String requestType) {
        ...
        try {
            ...
            response = ApiInvocation.handleRequest(reqSpecList.get(activeIndex));
            logger.info("\n\nResponse Body:\n" + response.getResponseBody());
            responseList.add(response);
        } catch (Exception e) {
            GemTestReporter.addTestStep(requestType.toUpperCase() + " Request Verification ", requestType.toUpperCase() + " Request Did not Executed Successfully", STATUS.FAIL);
    ...
    public static void verifyKeyAndValuePresence(String pathProvided, String expectedValue) {
        try {
            ...
            Object valueFoundAtPath = JsonPath.read(res.getResponseBody(), pathProvided);
    ...
    public static void verifyResponseSchema(String schemaName) {
        Response res = responseList.get(activeIndex);
        try {
//            res.assertThat().body(JsonSchemaValidator.matchesJsonSchema(new File(System.getProperty("user.dir") + "\\src\\test\\resources\\schemas\\" + schemaName + ".json")));
        } catch (Exception e) {
...
//                res.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(new File(System.getProperty("user.dir") + "\\src\\test\\resources\\schemas\\" + schemaName + ".json")));
    ...
    public static void verifyResponseTime(float expectedTimeInSeconds) {
        ...
        long actualTime = Long.parseLong(res.getExecTime());
        logger.info("Actual Time: " + actualTime + " milliseconds and expected time is: " + expectedTimeInSeconds * 1000 + " milliseconds");
        Assert.assertTrue(actualTime < expectedTimeInSeconds * 1000, "Response took longer than expected. Expected Time: Atleast " + expectedTimeInSeconds * 1000 + " milliseconds. Actual time: " + actualTime + " milliseconds");
    ...
    public static void messageValidation(String expectedMessage, Response... responses) {
        Response res = responseList.get(activeIndex);
        String responseMessage = res.getResponseBody();
    ...
    public static void verifyStatusCode(int statusCode) {
        Response res = responseList.get(activeIndex);
        Assert.assertEquals(statusCode, res.getStatus(),"Status code didn't match");
